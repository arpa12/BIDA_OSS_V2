export const workPermitCancellation = () => 
{
    ...
    cy.wait(2000);
    cy.xpath('/html/body/div[1]/nav/ul/li[5]/ul/li[1]/ul/li[10]/ul/li[8]/a').click();
    cy.wait(2000);
    ...
    cy.get('[name="date_of_cancellation"]').type('2025-12-10');
    cy.get('[name="date_of_cancellation"]').click();
    cy.wait(2000);
   ...
   //attachments
    cy.get('[id="file84"]').attachFile('demo.pdf')
    cy.wait(2000);
    cy.get('[id="file113"]').attachFile('demo.pdf')
    cy.wait(2000);
    cy.get('[id="file114"]').attachFile('demo.pdf')
    cy.wait(2000);
    cy.get('[id="file115"]').attachFile('demo.pdf')
    cy.wait(2000);
    cy.get('[id="file117"]').attachFile('demo.pdf')
    cy.wait(2000);
    cy.xpath('/html/body/div[1]/div/div/div[4]/section/div/div/div/div/div[2]/form/div[3]/ul/li[2]/a').click();
    cy.wait(2000);
