export const officePermissionCancellation = () =>
{
    ...
    cy.wait(2000);
    cy.xpath('/html/body/div[1]/nav/ul/li[6]/ul/li[1]/ul/li[2]/ul/li[11]/a').click();
    cy.wait(2000);
...
cy.wait(5000);
cy.get('[id="effect_date"]').type('2024-07-01');
cy.wait(2000);
cy.get('[id="applicant_remarks"]').type('Automation test cancellation remarks');
cy.wait(2000);
...
cy.wait(2000);
    ...
    //Attachment
   cy.get('[id="file77"]').attachFile('demo.pdf')
   cy.wait(2000);
   cy.get('[id="file78"]').attachFile('demo.pdf')
   cy.wait(2000);
   cy.get('[href="#next"]').should('be.visible').click();
...
export const officePermissionCancellationFinalPayment = () =>
{
    cy.xpath('/html/body/div[1]/nav/ul/li[5]/a').click();
    cy.wait(2000);
    cy.xpath('/html/body/div[1]/nav/ul/li[5]/ul/li[1]/a').click();
