export const officePermissionAmendment = () =>
{
    ...
    cy.wait(2000);
    cy.xpath('/html/body/div[1]/nav/ul/li[5]/ul/li[1]/ul/li[2]/ul/li[8]/a').click();
    cy.wait(2000);
    ...
    //Basic Information
cy.xpath('/html/body/div[1]/div/div/div[4]/section/div/div/div/div/div[2]/form/div[2]/fieldset[1]/div[1]/div[2]/div/div/div[1]/div/div/div/label[1]/input').click();
cy.wait(2000);
cy.get('[name="ref_app_tracking_no"]').type('OPN-13Jan2026-00002');
cy.wait(2000);
cy.get('[id="searchOPinfo"]').click();
cy.wait(5000);
cy.get('[href="#next"]').should('be.visible').click();
cy.get('[name="effective_date"]').type('2024-07-01');
cy.wait(2000);
cy.get('[id="n_ex_office_post_code_check"]').click();
cy.wait(2000);
cy.get('[name="n_ex_office_post_code"]').type('1216');
cy.wait(2000);
cy.get('[href="#next"]').should('be.visible').click();
cy.wait(2000);

    //Attachment
   cy.get('[id="file67"]').attachFile('demo.pdf')
   cy.wait(2000);
   cy.get('[id="file68"]').attachFile('demo.pdf')
   cy.wait(2000);
   cy.get('[href="#next"]').should('be.visible').click();
