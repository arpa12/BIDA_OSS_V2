...
describe('IRC Recommendation 1st Adhok', () => {
  it('IRC Recommendation 1st Adhok Form Fillup & Submit Application with Payment', () => {
   ...
   it.skip('IRC Recommendation 1st Adhok Application Processing - Step 1', () => {
         cy.visit('/')
   ...
   it.skip('IRC Recommendation 1st Adhok Application Processing - Step 2', () => {
         cy.visit('/')
    ...
    it.skip('IRC Recommendation 1st Adhok Application Processing - Step 3', () => {
         cy.visit('/')
     ...
     it.skip('IRC Recommendation 1st Adhok Application Processing - Step 4', () => {
         cy.visit('/')
     ...
     it.skip('IRC Recommendation 1st Adhok Application Processing - Step 5', () => {
         cy.visit('/')
