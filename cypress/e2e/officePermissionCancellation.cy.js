...
import { officePermissionCancellation, officePermissionCancellationFinalPayment } from "../pages/officePermission/officePermissionCancellation";

describe('Office permission Cancellation', () => {
  it('Office permission Cancellation Form Fillup & Submit Application with Payment', () => {
   ...
   it.skip('Office Permission Application Processing - Step 3', () => {
    ...
    bidaRegistrationNew.dashboardInnerModal()
      ...
      officePermissionCancellationFinalPayment();
      // cy.xpath('/html/body/div[1]/nav/ul/li[4]/a').click();
      // cy.xpath('/html/body/div[1]/nav/ul/li[4]/ul/li[5]/a').click();  
    });
