...
import { bidaRegistrationStep1, bidaRegistrationStep2, bidaRegistrationStep3 } from "../pages/applicationProcess";
...
describe('BIDA Registration Full Process', () => {
  it.skip('BIDA Registration Form Fillup', () => {
    // Handle cross-origin uncaught exceptions before visiting any page
    cy.origin('https://id-test.oss.net.bd', () => {
...
// Fill out the BIDA Registration Form
    ...
    cy.wait(5000)
    cy.get('[class="navbar-header nav-logo"]').should('be.visible').as('navLogo')
    ...
    cy.get('[id="machinery_create_btn"]').should('be.visible').click()
    cy.wait(5000)
    cy.get('[class="navbar-header nav-logo"]').should('be.visible').as('navLogo2')
    cy.get('@navLogo2').click()
    cy.wait(2000)
    cy.contains('My Desk').should('be.visible').click()
    cy.wait(3000)
    cy.xpath('/html/body/div[1]/div/div/section/div/div/div[3]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div/table/tbody/tr[1]/td[6]/a').should('be.visible').eq(0).click()
  ...
  it('BIDA Registration Final Payment', () => {
      cy.visit('/')
